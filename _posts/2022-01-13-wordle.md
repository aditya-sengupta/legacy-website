...
![](https://en.wikipedia.org/wiki/Binary_entropy_function#/media/File:Binary_entropy_plot.svg)
...
![](aditya-sengupta.github.io/assets/images/soare.png)

And here’s the same distribution if our first guess is ‘fuzzy’, one of the worst:

![](aditya-sengupta.github.io/docs/assets/images/fuzzy.png)
